# conversation/services/nlp_service.py
import random
from datetime import datetime, timedelta


class NLPService:
    """Dummy NLP service - in a real app, replace with actual NLP models"""
    ...
    def determine_latency(self, message_content: str, contact_history=None) -> int:
        ...
        # Dummy implementation - return between 1 and 120 minutes
